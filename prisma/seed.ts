...
async function main() {
    ...
    // Create camera systems for the admin user
    const cameraSystemSonyA7IV = await prisma.cameraSystem.create({
        data: {
            name: 'Sony A7 IV · SeaFrogs SF-A7IV-SL',
            userId: adminUser.id,
    ...
    const cameraSystemIphone = await prisma.cameraSystem.create({
        data: {
    ...
    await prisma.user.update({
        ...
        data: { defaultCameraSystemId: cameraSystemSonyA7IV.id },
    })
        ...
        data: [
            {
                ...
                height: 854,
                userId: adminUser.id,
                cameraSystemId: cameraSystemSonyA7IV.id,
                focalLength: 47,
                aperture: 16,
                shutterSpeed: 0.005,
                iso: 400,
            ...
            // iPhone 14 Pro photos through DiveVolk SeaTouch 4 Pro
            {
                ...
                height: 2028,
                userId: adminUser.id,
                cameraSystemId: cameraSystemIphone.id,
                focalLength: 2.2,
                aperture: 2.2,
