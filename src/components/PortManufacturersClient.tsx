...
export default function PortManufacturersClient({ manufacturers: initial, housingMounts, isSuperuser }: Props) {
    ...
    async function handlePortAdd() {
        ...
        try {
            const productPhotos = await uploadPhotoSlots(photos, '/api/admin/ports/photos', { manufacturerSlug: portTargetMfr.slug })
            ...
            {(portModal === 'add' || portModal === 'edit') && portTargetMfr && (
                ...
                >
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
                        ...
                        <PhotoUploadField value={photos} onChange={setPhotos} pasteListenerActive={!!portModal} />
