            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-between items-center h-16 md:h-20">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link href="/builder" className="text-gray-700 dark:text-gray-300 hover:text-blue-900 dark:hover:text-blue-400 transition-colors font-medium">
                            Builder
                        </Link>
                        ...
                        <Link href="/about" className="text-gray-700 dark:text-gray-300 hover:text-blue-900 dark:hover:text-blue-400 transition-colors font-medium">
                            About
                        </Link>
