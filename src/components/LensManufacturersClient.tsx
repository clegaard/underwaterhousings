...
export default function LensManufacturersClient({ manufacturers: initial, cameraMounts, isSuperuser }: Props) {
    ...
    function resetLensForm() {
        ...
        setEntrancePupilDistanceTele(''); setEntrancePupilDistanceWide('')
    }
    ...
    async function handleLensAdd() {
        ...
        try {
            const productPhotos = await uploadPhotoSlots(photos, '/api/admin/lenses/photos', { manufacturerSlug: lensTargetMfr.slug })
